...
def dataTransformer(path=None,delimiter=','):
    ...
    numpy.savetxt(fname='/home/rahul/Dropbox/MyWork/RAN_CRBMv1.0/data/newDataToExplore/new/MammographicMassData/RansForm1.csv',X=data5,fmt='%f',delimiter=',')
    print('x')
...
if __name__=='__main__':
    path='/home/rahul/Dropbox/MyWork/RAN_CRBMv1.0/data/newDataToExplore/new/MammographicMassData/originalData.csv'
